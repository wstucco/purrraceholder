{{ template "includes/header" }}
	<div class="content">
		...
		<p><a href="/700x300">/700x300</a> or <a href="/700/300">/700/300</a> generate an image 700px wide and 300px tall</p>
		<p>max size is 2560px for both dimensions</p>

		{{if .ImageUrl}}
		<p>View the <a href="{{ .ImageUrl }}"> latest purrraceholder generated (not cached)</a></p>
		{{end}}
  </div>
